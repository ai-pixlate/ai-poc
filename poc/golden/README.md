...
| 4 | 브랜드 로고 제외 재확인 | `poc/logo_match` | [4_logo_match](4_logo_match/summary.md) | 실행 완료(비용 0) · 기존 정답과 기계 대조 완료 | 찾음 5 · 놓침 2 · 오탐 0 — **미달**(기존 6·1·0보다 놓침 +1) · 영역 단위 대안 측정(놓침 1 · 오탐 5) 후 **현행 유지로 종결** |
| 5 | 원문 지우기 | `poc/E1_inpaint` | [5_E1_inpaint](5_E1_inpaint/summary.md) | 실행 완료(비용 0) · Claude 1차 판정 완료 · 예람님 검토 대기 | `erase_all` 66% · 사진 54% — **미달** / `erase_s50` 72% · 사진 71% — 통과 · **확정 조건을 `erase_s50`으로 변경**(2026-09-16) |
